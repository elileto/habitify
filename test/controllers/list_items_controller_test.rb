...
class ListItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create list_item" do
    assert_difference('ListItem.count') do
      post list_items_url, params: { list_item: { complete: @list_item.complete, counter: @list_item.counter, difficultyLvl: @list_item.difficultyLvl, experiencePoints: @list_item.experiencePoints, task: @list_item.task } }
    end
  ...
  test "should update list_item" do
    patch list_item_url(@list_item), params: { list_item: { complete: @list_item.complete, counter: @list_item.counter, difficultyLvl: @list_item.difficultyLvl, experiencePoints: @list_item.experiencePoints, task: @list_item.task } }
